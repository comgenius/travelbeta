...
const PaymentMethods = () => {
  ...
  <div className="mt-10 flex items-center justify-center space-x-8 px-6 lg:px-0">
    <div className="flex flex-col items-center font-bold">
      <div className="leading-none flex items-center justify-center Booking_w_sp__1NGoC Booking_text_10__4KSam bg-prim-default text-white rounded-lg">1</div>
      <div className="Booking_text_10__4KSam Booking_mt_1_5__FJmAi text-center">Room Selected</div>
    </div>
    <div className="flex flex-col items-center font-bold">
      <div className="leading-none flex items-center justify-center Booking_w_sp__1NGoC Booking_text_10__4KSam bg-prim-default text-white rounded-lg">2</div>
      <div className="Booking_text_10__4KSam Booking_mt_1_5__FJmAi text-center">Additional Information</div>
    </div>
    <div className="flex flex-col items-center font-bold">
      <div className="leading-none flex items-center justify-center Booking_w_sp__1NGoC Booking_text_10__4KSam bg-prim-default text-white rounded-lg">3</div>
      <div className="Booking_text_10__4KSam Booking_mt_1_5__FJmAi text-center">Payment Methods</div>
    </div>
    <div className="flex flex-col items-center font-normal">
      <div className="leading-none flex items-center justify-center Booking_w_sp__1NGoC Booking_text_10__4KSam rounded-lg">4</div>
      <div className="Booking_text_10__4KSam Booking_mt_1_5__FJmAi text-center">Booking Confirmation</div>
    </div>
  </div>
        ...
        <div>
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-col lg:flex-row space-y-7 lg:space-x-7 lg:space-y-0 py-9 border-b border-neutral-400">
              <div className="flex items-center"><input type="radio" className="Booking_radio__1P3jI" defaultValue="bank" defaultChecked /><label className="text-neutral-100 text-sm font-semibold ml-3">Bank Account</label></div>
              <div className="flex items-center"><input type="radio" className="Booking_radio__1P3jI" defaultValue="domestic" /><label className="text-neutral-100 text-sm font-semibold ml-3">Domestic Card</label></div>
            </div>
          </div>
          <div>
            <div className="mt-8">
              <h4 className="text-sm font-semibold text-neutral-100">How to pay into our bank account</h4>
              <p className="mt-2 w-full Booking_w_400__2WqKq text-xs leading-5 text-neutral-300">
              ...
              <div className="mt-6 Booking_w_340__b6QUa space-y-4">
            ...
            <div className="mt-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="p-6 border rounded-lg w-full" style={{borderColor: 'rgb(206, 212, 218)'}}>
                  <img src="https://res.cloudinary.com/diapyzzws/image/upload/v1648466370/Website%20Images/globus-logo.svg" className="h-10 object-scale-down" />
                  <p className="text-sm font-semibold mt-4">Globus bank</p>
                  <div className="flex flex-col">
                    <span className="text-sm leading-6 text-neutral-100">Account Name:</span>
                    <div className="flex justify-between">
                      <span className="text-sm leading-6 text-neutral-100 font-semibold">Travelbeta.com Limited</span>
                  ...
                  <div className="flex flex-col mt-4">
                    <span className="text-sm leading-6 text-neutral-100">Account Number:</span>
                    <div className="flex justify-between">
                      <span className="text-sm leading-6 text-neutral-100 font-semibold">1000036785</span>
                      <button className="text-sm leading-6 text-neutral-300 font-semibold">
                        <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                          <path fill="none" d="M0 0h24v24H0z" />
                          <path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z" />
                ...
                <div className="p-6 border rounded-lg w-full" style={{borderColor: 'rgb(206, 212, 218)'}}>
                  <img src="https://res.cloudinary.com/diapyzzws/image/upload/v1648466377/Website%20Images/gtb-bank.jpg" className="h-10 object-scale-down" />
                  <p className="text-sm font-semibold mt-4">Guaranty Trust Bank</p>
                  <div className="flex flex-col">
                    <span className="text-sm leading-6 text-neutral-100">Account Name:</span>
                    <div className="flex justify-between">
                      <span className="text-sm leading-6 text-neutral-100 font-semibold">Travelbeta.com Limited</span>
                  ...
                  <div className="flex flex-col mt-4">
                    <span className="text-sm leading-6 text-neutral-100">Account Number:</span>
                    <div className="flex justify-between">
                      <span className="text-sm leading-6 text-neutral-100 font-semibold">0225873859</span>
                      <button className="text-sm leading-6 text-neutral-300 font-semibold">
                        <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                          <path fill="none" d="M0 0h24v24H0z" />
                          <path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z" />
          ...
          <div className="mt-14 mb-12">
            <button className="py-4 px-6 mx-auto text-white bg-cta flex items-center space-x-4 text-base leading-4 font-bold rounded opacity-100">
      ...
      <div className="flex w-full items-center h-32 bg-white" style={{boxShadow: 'rgba(109, 109, 109, 0.14) 0px 14px 25px -8px'}}>
        ...
        <div className="w-3/5 py-6 px-4">
          ...
          <div className="mt-4 flex items-center">
            ...
            <span className="Booking_text_9l__r7JTg leading-3 text-neutral-200 ml-1.5">639 Harrow Road ; Kensal Green</span>
          </div>
        </div>
      </div>
      <div className="bg-white mt-10 lg:mt-16 px-6">
        <div className="py-6 border-b border-neutral-400"><h2 className="text-sm lg:text-2xl leading-none text-neutral-100 font-semibold">basic shared dormitory, shared bathroom (8 bed female dorm)</h2></div>
        <div className="space-y-6 py-6 pb-8 border-b border-neutral-400">
          <div className="flex justify-between">
            <p className="text-sm leading-none text-neutral-100">Number of rooms</p>
            <p className="text-sm leading-none text-neutral-100 font-semibold">1</p>
          </div>
          <div className="flex justify-between">
            <p className="text-sm leading-none text-neutral-100">Maximum occupancy</p>
            <p className="text-sm leading-none text-neutral-100 font-semibold">1</p>
          </div>
        </div>
        <div className="flex justify-between items-center py-6 border-b border-neutral-400">
          <div className="space-y-2.5">
            <p className="text-sm leading-none text-neutral-300">Check-In</p>
            <p className="text-sm leading-none text-black">Jan 14 2023</p>
          </div>
          <div className="space-y-2.5">
            <p className="text-sm leading-none text-neutral-300">Check-Out</p>
            <p className="text-sm leading-none text-black">Jan 17 2023</p>
          </div>
        </div>
        <div className="py-6 border-b border-neutral-400"><h4 className="text-sm leading-none text-neutral-100 font-semibold">Hotel Base Fare</h4></div>
        <div className="space-y-6 py-6 border-b border-neutral-400">
          <div className="flex justify-between">
            <p className="text-sm leading-none text-neutral-100">1 Room x 3 nights</p>
            <p className="text-sm leading-none text-neutral-100">₦47,817</p>
          </div>
          <div className="flex justify-between">
            <p className="text-sm leading-none text-neutral-100">Discount</p>
            <p className="text-sm leading-none text-neutral-100">₦0</p>
          </div>
          <div className="flex justify-between">
            <p className="text-sm leading-none text-neutral-100">Total Fare</p>
            <p className="text-sm leading-none text-neutral-100">₦47,817</p>
          </div>
        </div>
        <div className="py-6">
          <div className="flex justify-between">
            <p className="text-xl leading-none text-neutral-100 font-bold">Total:</p>
            <p className="text-xl leading-none text-neutral-100 font-bold">₦47,817</p>
          </div>
        </div>
      </div>
    </div>
