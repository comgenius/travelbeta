...
const PaymentMethodsBankAccountPage = () => {
  return (
    <>
      <div className="bg-gray_50 flex flex-col font-metropolis items-center justify-end mx-[auto] pt-[1px] w-[100%]">
        ...
        <div className="flex flex-col items-center justify-end sm:mt-[37px] md:mt-[48px] mt-[71px] w-[100%]">
          <div className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center max-w-[490px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <div className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[16%]">
              <Text
            ...
            <div className="flex flex-col items-center md:ml-[37px] ml-[55px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[12%]">
              <Text
            ...
            <div className="flex flex-col items-center md:ml-[37px] ml-[55px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[19%]">
              <Text
                className="bg-indigo_900 flex font-bold items-center px-[3px] rounded-radius50 text-white_A700 w-[14px]"
                variant="body3"
              >
            ...
            <div className="flex flex-col items-center md:ml-[37px] ml-[55px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
              <Text
          ...
          <div className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1200px] ml-[auto] mr-[auto] sm:mt-[21px] md:mt-[28px] mt-[41px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <div className="bg-white_A700 flex flex-col items-center sm:mx-[0] sm:p-[15px] md:p-[27px] p-[40px] sm:w-[100%] w-[63%]">
              <div className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[75%]">
                <div className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[62%]">
                  <Text
                    className="font-semibold text-gray_900 w-[auto]"
                    as="h4"
                    variant="h4"
                  ...
                  <Text
                    ...
                    variant="body1"
                  >
                    Guarantee your booking before time runs out.
                  </Text>
                </div>
                <div className="flex flex-col justify-start sm:mt-[17px] md:mt-[22px] mt-[32px] sm:px-[0] w-[100%]">
                  <div className="flex flex-col justify-start w-[100%]">
                    ...
                    <RadioGroup
                      className="flex sm:mt-[17px] md:mt-[22px] mt-[32px] w-[100%]"
                      name="radiogroupbankaccount"
                    >
                      <Radio
                        value="BankAccount"
                        className="font-semibold text-[14px] text-gray_900"
                      ...
                      <Radio
                        value="DomesticCard"
                        className="font-semibold sm:ml-[21px] md:ml-[27px] ml-[40px] text-[14px] text-gray_900"
                        inputClassName="mr-[5px]"
                        checked={false}
                        name="radiogroupbankaccount"
                        label="Domestic Card"
                  ...
                  <div className="flex flex-col justify-start sm:mt-[16px] md:mt-[21px] mt-[31px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[81%]">
                    <div className="flex flex-col justify-start w-[100%]">
                      <Text
                        className="font-semibold text-gray_900 w-[auto]"
                        variant="body1"
                      ...
                      <Text
                        ...
                        variant="body2"
                      >
                        Visit any of the banks listed below, and make payment.
                        However, you can make a transfer to any of our bank
                        accounts from your mobile banking application. Once your
                        payment is confirmed, your reservation will be
                        processed.
                      </Text>
                    </div>
                    <div className="flex flex-col items-center justify-start sm:mt-[12px] md:mt-[16px] mt-[24px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[86%]">
                      ...
                      <div className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between md:mt-[11px] mt-[16px] sm:mt-[8px] w-[100%]">
                        <Text
                          className="font-normal not-italic text-bluegray_400 w-[auto]"
                          variant="body1"
                        >
                ...
                <div className="flex flex-col items-center justify-start sm:mt-[17px] md:mt-[22px] mt-[32px] w-[100%]">
                  <Grid className="sm:gap-[12px] md:gap-[16px] gap-[24px] grid sm:grid-cols-1 grid-cols-2 min-h-[auto] w-[100%]">
                    <div className="bg-white_A700 flex flex-col justify-start outline outline-[1px] outline-bluegray_100 sm:p-[15px] md:p-[16px] p-[24px] rounded-radius8 shadow-bs5 w-[100%]">
                      <Img
                      ...
                      <Text
                        className="font-semibold leading-[24.00px] md:leading-[normal] sm:leading-[normal] md:mt-[12px] mt-[18px] sm:mt-[9px] text-gray_900 w-[100%]"
                        variant="body1"
                      >
                        <span className="text-[14px] font-metropolis font-normal not-italic">
                          Account Name: <br />
                        </span>
                        <span className="text-[14px] font-metropolis">
                          Travelbeta.com Limited
                        </span>
                      </Text>
                      <Text
                        className="font-semibold leading-[24.00px] md:leading-[normal] sm:leading-[normal] md:mt-[11px] mt-[16px] sm:mt-[8px] sm:mx-[0] text-gray_900 sm:w-[100%] w-[90%]"
                        variant="body1"
                      >
                        <span className="text-[14px] font-metropolis font-normal not-italic">
                          Account Number: <br />
              ...
              <Button
                className="cursor-pointer font-bold sm:mb-[21px] md:mb-[27px] mb-[40px] min-w-[30%] sm:mt-[29px] md:mt-[38px] mt-[56px] text-[16px] text-center text-white_A700 w-[max-content]"
                shape="RoundedBorder4"
                size="xl"
              >
                Create Reservation
            ...
            <div className="bg-blue_50 flex flex-col items-center sm:mx-[0] sm:p-[15px] md:p-[27px] p-[40px] sm:w-[100%] w-[38%]">
              ...
              <div className="bg-white_A700 flex flex-col justify-start sm:mb-[189px] md:mb-[244px] mb-[356px] sm:mt-[22px] md:mt-[28px] mt-[42px] md:p-[13px] sm:p-[15px] p-[20px] w-[100%]">
                <Text
          ...
          <footer className="bg-gray_901 mt-[137px] sm:mt-[72px] md:mt-[94px] w-[100%]">
